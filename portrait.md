...
title: 인물 및 사진
nav_order: 2
description: "인물·사진 스타일의 프롬프트 사례"
permalink: /portrait/
---
...
## Case 1: 편의점 네온 인물 사진  (@BubbleBrain)
...
## Case 3: 일본 온천 료칸 인물 사진  (@BubbleBrain)
...
## Case 4: 35mm 플래시 에디토리얼 인물 사진  (@BubbleBrain)
...
## Case 6: 부드럽고 가벼운 35mm 인물 사진  (@BubbleBrain)
...
## Case 8: 9:16 코스플레이어 인물 스크린샷  (@Zoulinshen)
...
## Case 10: 샘 알트만 스케이트파크 스냅샷  (@Malek1173989)
...
## Case 12: CCD 카메라 플래시 한국 아이돌  (@BubbleBrain)
...
## Case 14: 부드러운 블랙 미스트 에디토리얼 인물 사진  (@BubbleBrain)
...
## Case 16: 부드러운 블랙 미스트 아이돌 인물 사진  (@BubbleBrain)
...
## Case 22: 그린티 필름 키트 제품 사진  (@ZaraIrahh)
...
## Case 24: 노트북 위 초현실 UI/UX 목업  (@ZaraIrahh)
