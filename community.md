...
title: 비교 및 커뮤니티
nav_order: 6
description: "다양한 커뮤니티 비교/실험 프롬프트 사례"
permalink: /community/
---
...
## Case 5: Wooden Bookshelf Prompt Test  (@chetaslua)
...
## Case 16: A/B Test Signed Output  (@saskr_13)
...
## Case 29: Lion Camel Ridge Dark Myth Scene  (@MANISH1027512)
...
## Case 31: Pre-war Japan Lab Minecraft Screenshot  (@RitaStar1128)
...
## Case 32: Forged Masterpiece Prompt Test  (@MrLarus)
...
## Case 34: Rust In-Game Screenshot  (@FixlationAI)
...
## Case 36: Among Us Realistic Screenshot  (@ReYYYYoking)
...
## Case 38: 14th-Dimension Projection Scene  (@workingclassbud)
...
## Case 40: Based on the video content and this current frame, use GPT to generate a YouT...  (@chatcutapp)
...
## Case 42: Edit this image so that total amount changes to 244.5 baht. You can change th...  (@elliscrosby)
...
## Case 44: 2025년 가장 중요한 사건  (@Rufus87078959)
...
## Case 46: 360도 정거원통 파노라마 이미지  (@rs_elwood)
...
## Case 47: 개인 지식 인포그래픽 초상화  (@aitorwilzig)
...
## Case 49: 더우인 라이브 판매 스크린샷  (@laogeai)
...
## Case 51: 여포 보스 디자인 시트  (@songguoxiansen)
...
## Case 52: 나타 다크 판타지 소설 표지  (@songguoxiansen)
...
## Case 54: 소달기 고풍 글래머 초상화  (@nidiedeba)
...
## Case 55: 루쉰 아침꽃 저녁에 줍다 일러스트  (@Aurora_62340)
...
## Case 57: 중국 항공우주 기념 우표 시트  (@songguoxiansen)
...
## Case 59: 불경 기반 사실적 관음보살 초상  (@Zhaoge01)
...
## Case 61: 양귀비 사실적 역사 초상화  (@Zhaoge01)
...
## Case 63: 도산아아 판타지 글래머 초상화  (@sdjn_wgc)
...
## Case 64: 더우인 라이브 판매 스크린샷  (@LVWANGJI_0327)
...
## Case 66: 젊은 동양 여성 세로 아트 초상화  (@zhiyangzhu22222)
...
## Case 67: 오토봇 달 기지 집결  (@songguoxiansen)
...
## Case 69: 폴라로이드 프레임 탈출 장면  (@MajaDesignJP)
...
## Case 70: 2D 애니메 캐릭터 현실 세계 그리드 장면  (@seiiiiiiiiiiru)
